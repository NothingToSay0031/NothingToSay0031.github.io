...
### 什么是着色器编译卡顿（Shader Compilation Stuttering）
...
## 旧方案——捆绑 PSO 缓存（Bundled PSO Cache）
...
## 新方案—— PSO 预缓存（PSO Precaching，UE 5.2+）
...
## 尚未完全覆盖的区域——全局着色器（Global Shaders）
...
### 关注其他类型的遍历卡顿（Traversal Stuttering）
