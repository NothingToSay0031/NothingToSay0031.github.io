...
## 常见GI方案光谱 (The Spectrum of GI Solutions)
...
### 成功的关键：防漏光 (Light Leak Prevention)
...
### 存储方案：稀疏树形结构 (Sparse Tree Structure)
...
### 树的层级与构建 (Tree Hierarchy & Construction)
...
### 运行时查询算法 (Runtime Lookup Algorithm)
...
### 数据拟合与压缩 (Data Fitting & Compression)
...
### 总体方案：Light Map 为主，Volume GI 为辅
...
### 防漏光：Interior Volume (IV) 方案 (代码量最大)
